		...
		if (isset($_POST['updateschedule'])) {
			...
			if ($count == 1) {
				...
				try {
					...
					// Success
					$feedback .= '<div class="alert alert-success" role="alert">Update successful.<br> 
						<a href="updateschedules.php">Back to Update Schedules</a><br>
						<a href="weeklyschedules.php">Back to Update Weekly</a></div>';
				} catch (Exception $e) {
					// An error occured
					$feedback .= '<br />
				...
				// An employee does not has a schedule for this week
				$feedback .= '<br />
							<p class="text-danger">A schedule for this week does not exist.</p>';
			}
		}
